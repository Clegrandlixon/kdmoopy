...
# python3 experiments.py -c 101 R 50 20 1000 100 10 0.5 0.5
...
case $1 in
	...
	case $6 in
	    100)
		python3 experiments_vrptw.py $1 1 $2 $3 $4 $5 $6 $7 60 15 "d2" 50 "FIRST-BEST" 0.50 0.00 0.10 1 5 "standard" 1 60 0.75 1;;
	esac;;
