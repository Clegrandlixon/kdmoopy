...
class MOEAD(GeneticAlgorithm):
    ...
    def create_initial_solutions(self) -> List[S]:
        ...
        for i in range(self.population_size):
            s = self.population_generator.new(self.problem)
            s.weights = self.neighbourhood.weight_vectors[i]
            solutions.append(s)
        return solutions
    ...
    def init_progress(self) -> None:
        ...
        for solution in self.solutions:
            ...
            solution.weights = weight_vector
    ...
    def update_current_subproblem_neighborhood(self, new_solution, population):
        ...
        for i in range(len(permuted_neighbors_indexes)):
            ...
            f1 = self.fitness_function.compute_fast(population[k].objectives, self.neighbourhood.weight_vectors[k])
            f2 = self.fitness_function.compute_fast(new_solution.objectives, self.neighbourhood.weight_vectors[k])
